...
| --- | --- | --- |
| Hero, full-bleed *(in use)* | 4 × 6 or 6 × 4 | One big hero photo (the first picked) with three tiled beside it, filling the whole sheet edge to edge; photos crop to fill, sheet rotates to suit the hero |
